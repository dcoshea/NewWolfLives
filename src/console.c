...
// logging settings
	...
	{
		fprintf(fp, "\n");
		fprintf(fp, "This file was generated by %s version %4.2f\n\n", NEWWOLF_NAME, VERSION);
		fprintf(fp, "If you have problems with it, report the issue at\n");
		fprintf(fp, "https://github.com/dcoshea/NewWolfLives/issues with\n");
		fprintf(fp, "a problem description and this file.\n\n");
		fclose(fp);
	}
	else
	{
